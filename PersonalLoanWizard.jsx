    ...
    return (
      <div className="content">
        <div className="card">
          ...
          <p>
            Thank you {form.name}, your personal loan application has been submitted successfully.
  ...
  <div className="sidebar-steps" role="tablist" aria-label="Loan steps">
    ...
    <span className="progress-text">{progressPct}%</span>
        ...
        <div className="card">
          ...
          {step === 2 && (
            <div className="form-step active grid-2">
              <div className="field"><label>Desired Loan Amount (₹)</label>
                <input name="loanAmount" inputMode="numeric" value={form.loanAmount} onChange={handleChange} />
              </div>
              <div className="field"><label>Tenure (Years)</label>
              ...
              <div className="field"><label>Loan Nature</label>
          ...
          {step === 3 && (
            <div className="form-step active">
              ...
              {form.existingEmis === "yes" && form.liabilities.map((row, i) => (
          ...
          {step === 4 && (
            <div className="form-step active grid-2">
              <div className="field"><label>Loan Usage Details</label>
                <textarea name="loanUsage" value={form.loanUsage} onChange={handleChange} placeholder="Explain how you will use the loan…" />
              </div>
              <div className="field"><label>Do you have a guarantor?</label>
          ...
          {step === 5 && (
            <div className="form-step active">
              <div className="grid-2">
                <div className="field"><label>Any outstanding judgments?</label>
                  <select name="hasJudgements" value={form.hasJudgements} onChange={handleChange}>
                    <option value="no">No</option><option value="yes">Yes</option>
                  </select>
                </div>
                <div className="field"><label>Declared bankruptcy in last 7 years?</label>
                  <select name="bankrupt" value={form.bankrupt} onChange={handleChange}>
                    <option value="no">No</option><option value="yes">Yes</option>
                  </select>
                </div>
                <div className="field"><label>Any past defaults on personal/consumer loans?</label>
                  <select name="defaulted" value={form.defaulted} onChange={handleChange}>
                    <option value="no">No</option><option value="yes">Yes</option>
                  </select>
                </div>
                <div className="field"><label>Politically Exposed Person?</label>
          ...
          {step === 6 && (
            <div className="form-step active emi-box">
              ...
              <div className="emi-results" style={{ marginTop: 12 }}>
                <div className="emi-line"><span>Monthly EMI</span>
                  <strong>₹ {Math.round(calculateEMI()).toLocaleString("en-IN")}</strong>
                </div>
                <div className="emi-line"><span>Total Payable</span>
                  <strong>₹ {(Math.round(calculateEMI() * ((parseInt(form.tenure, 10) || 0) * 12))).toLocaleString("en-IN")}</strong>
                </div>
              </div>
            </div>
          )}
          ...
          {step === 7 && (
            <div className="form-step active review">
              ...
              <ul className="status-list">
                ...
                <li><span>Loan Type</span><span>{form.purpose}</span></li>
